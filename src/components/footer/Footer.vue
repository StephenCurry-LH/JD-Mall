<template>
  <div>
    <footer class="footer">
      <!--footer header相关知识详见https://www.cnblogs.com/zdz8207/p/vue-header-footer-emit.html-->
      ...
      <div class="service-intro">
        ...
        <div class="clearfix"></div>
        <div class="copyright">
         // <p>Copyright © 2019 by Lihang <a href="https://github.com/PowerDos"><Icon type="social-github"></Icon></a> <span></span></p>
        </div>
      </div>
    </footer>
  </div>
